...
import { EntityAtttributeRow, checkIfFetchIdInRedis, downloadFileToDisk, exportDBEntitiesAsJson, getFetchIdFromRedis, getRowAttrsToGQLAttrs, loadDbFromDisk } from "./helpers.js";
import { RedisAbstraction } from "./redisClient.js";
...
export async function getFetchIDJson(redis: RedisAbstraction, fileKey: string): Promise<object> {
  // step 1
